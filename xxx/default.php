...
$tpl->template_dir    = $_SERVER['DOCUMENT_ROOT'] . '/xxx';
$tpl->compile_dir    = $_SERVER['DOCUMENT_ROOT'] . '/xxx/templates_c';
$keyword_file = $_SERVER['DOCUMENT_ROOT'] . '/xxx/data/titles.txt';


$defaulttitle = 'XXX Torrents';
...
$torrentlocation = $_SERVER['DOCUMENT_ROOT'] . '/xxx/torrents';
$torrentl = $_SERVER['DOCUMENT_ROOT'] . '/xxx/torrents';
