...
<head>
  ...
  <title>
    Search Results For {$torrent|replace:'%20':'
    '|replace:'#':'.'|replace:'/':'.'|replace:'\\':'.'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}
  </title>
  <meta name="description"
    content="Search Results For {$torrent|replace:'%20':' '|replace:'#':'.'|replace:'/':'.'|replace:'\\':'.'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}" />
  <meta name="keywords"
    content="{$torrent|replace:'%20':' '|replace:'#':'.'|replace:'/':'.'|replace:'\\':'.'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}" />
        ...
        <div class="box-info trending">
          <div class="box-info-heading clearfix">
            <h1>
              ...
              Top 4 Search Results For: {$torrent|replace:'%20':'
              '|replace:'#':'.'|replace:'/':'.'|replace:'\\':'.'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}
            </h1>
          </div>
        </div>
              ...
              <tbody>
                <tr>
                  <td class="coll-1 name">
                    <a href="{$torrent1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$xxxgroup1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-divx"></i></a><a
                      href="{$torrent1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$xxxgroup1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$torrent1|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$xxxgroup1|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$torrent2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$xxxgroup2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-divx"></i></a><a
                      href="{$torrent2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$xxxgroup2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$torrent2|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$xxxgroup2|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$torrent3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$xxxgroup3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-divx"></i></a><a
                      href="{$torrent3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$xxxgroup3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$torrent3|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$xxxgroup3|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$torrent4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$xxxgroup4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-divx"></i></a><a
                      href="{$torrent4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$xxxgroup4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$torrent4|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$xxxgroup4|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
