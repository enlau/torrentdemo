              ...
              <tbody>
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link0}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link0}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link1}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link1}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link2}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link2}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link3}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link3}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link4}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link4}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link5}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link5}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link6}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link6}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link7}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link7}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link8}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link8}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link9}" class="icon"><i class="flaticon-mp3"></i></a><a href=" // deprecated"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link10}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link10}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link11}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link11}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link12}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link12}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link13}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link14}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link14}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link14}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link15}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link15}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link16}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link16}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link17}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link17}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link18}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link18}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link19}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link19}"
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$link20}" class="icon"><i class="flaticon-mp3"></i></a><a href="{$link20}"
