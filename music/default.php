...
$tpl->template_dir	= $_SERVER['DOCUMENT_ROOT'] . '/music';
$tpl->compile_dir	= $_SERVER['DOCUMENT_ROOT'] . '/music/templates_c';   



// names of torrents to be created
$keyword_file = $_SERVER['DOCUMENT_ROOT'] . '/music/data/titles.txt';


$defaulttitle = 'Music Torrents';
...
$torrno = 1;
$maxnotorrent = 1;
$torrentlocation = $_SERVER['DOCUMENT_ROOT'] . '/music/torrents';
$torrentl = $_SERVER['DOCUMENT_ROOT'] . '/music/torrents';

//avatar image location
$authorImageLocation = $_SERVER['DOCUMENT_ROOT'] . '/music/product';
$lastpic = 170;
$picsperpage = 7;
$maxpic = 170;
