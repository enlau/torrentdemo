      ...
      <div class="clearfix">
        ...
        <div class="search-box">
          <form id="search-form" method="get" action="search.php">
            ...
            <div class="choose-search">{$searchbar5}</div>
          </form>
        </div>
      </div>
      <nav>
        <ul class="main-navigation">
          ...
          <li class="active"><a href="/movies/" title="Movies">Movies</a></li>
              ...
              <tbody>
                <tr>
                  <td class="coll-1 name">
                    <a href="{$torrent1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$moviegroup1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-h264"></i></a><a
                      href="{$torrent1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$moviegroup1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$torrent1|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$moviegroup1|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$torrent2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$moviegroup2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-h264"></i></a><a
                      href="{$torrent2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$moviegroup2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$torrent2|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$moviegroup2|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$torrent3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$moviegroup3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-h264"></i></a><a
                      href="{$torrent3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$moviegroup3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$torrent3|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$moviegroup3|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$torrent4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$moviegroup4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-h264"></i></a><a
                      href="{$torrent4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$moviegroup4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$torrent4|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$moviegroup4|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
