              ...
              <tbody>
                <tr>
                  <td class="coll-1 name">
                    <a href="{$newentry|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-apps"></i></a><a
                      href="{$newentry|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$newentry|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup1|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$newentry|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-apps"></i></a><a
                      href="{$newentry|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$newentry|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup2|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$newentry|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-apps"></i></a><a
                      href="{$newentry|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$newentry|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup3|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$newentry|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-apps"></i></a><a
                      href="{$newentry|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$newentry|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup4|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
