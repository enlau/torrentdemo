              ...
              <tbody>
                <tr>
                  <td class="coll-1 name">
                    <a href="{$torrent1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-apps"></i></a><a
                      href="{$torrent1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup1|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$torrent1|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup1|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$torrent2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-apps"></i></a><a
                      href="{$torrent2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup2|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$torrent2|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup2|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$torrent3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-apps"></i></a><a
                      href="{$torrent3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup3|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$torrent3|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup3|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
                ...
                <tr>
                  <td class="coll-1 name">
                    <a href="{$torrent4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html"
                      class="icon"><i class="flaticon-apps"></i></a><a
                      href="{$torrent4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup4|replace:'/':'-'|replace:' ':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}.html">{$torrent4|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}-{$gamesgroup4|replace:'/':'-'|replace:'%7B':'-'|replace:'%7D':'-'|replace:'#':'.'|replace:'\/':'-'|replace:'\\':'-'|replace:'%':'.'|replace:'[':'.'|replace:']':'.'}</a>
                  </td>
