...
$tpl->template_dir	= $_SERVER['DOCUMENT_ROOT'] . '/games';
$tpl->compile_dir	= $_SERVER['DOCUMENT_ROOT'] . '/games/templates_c';   
$keyword_file = $_SERVER['DOCUMENT_ROOT'] . '/games/data/titles.txt';
$defaulttitle = 'Game Torrents';
...
$tpl->assign('yourwebsite', $website);$lasttorrent = 1;
$torrno = 1;$maxnotorrent = 1;
$torrentlocation = $_SERVER['DOCUMENT_ROOT'] . '/games/torrents';
$torrentl = $_SERVER['DOCUMENT_ROOT'] . '/games/torrents';
