...
<h1><span class="featured-icon"><i class="flaticon-apps"></i></span> Verified Software Torrents  </h1>
...
<tbody>
<tr>
<td class="coll-1 name"><a href="{$link0}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link0}">{$tlink0}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link1}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link1}">{$tlink1}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link2}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link2}">{$tlink2}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link3}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link3}">{$tlink3}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link4}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link4}">{$tlink4}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link5}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link5}">{$tlink5}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link6}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link6}">{$tlink6}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link7}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link7}">{$tlink7}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link8}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link8}">{$tlink8}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link9}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link9t}.html">{$tlink9}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link10}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link10}">{$tlink10}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link11}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link11}">{$tlink11}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link12}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link12}">{$tlink12}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link13}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link14}">{$tlink13}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link14}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link14}">{$tlink14}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link15}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link15}">{$tlink15}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link16}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link16}">{$tlink16}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link17}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link17}">{$tlink17}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link18}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link18}">{$tlink18}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link19}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link19}">{$tlink19}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link20}" class="icon"><i class="flaticon-check-mark"></i></a><a href="{$link20}">{$tlink20}</a></td>
