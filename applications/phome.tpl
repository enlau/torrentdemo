...
<meta name="description" content="{$mytitle}{$pnumber}">
<meta name="keywords" content="{$mytitle}{$pnumber}">
...
<tbody>
<tr>
<td class="coll-1 name"><a href="{$link0}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link0}" title="{$tlink0}">{$tlink0}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link1}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link1}" title="{$tlink1}">{$tlink1}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link2}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link2}" title="{$tlink2}">{$tlink2}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link3}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link3}" title="{$tlink3}">{$tlink3}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link4}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link4}" title="{$tlink4}">{$tlink4}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link5}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link5}" title="{$tlink5}">{$tlink5}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link6}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link6}" title="{$tlink6}">{$tlink6}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link7}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link7}" title="{$tlink7}">{$tlink7}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link8}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link8}" title="{$tlink8}">{$tlink8}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link9}" class="icon"><i class="flaticon-apps"></i></a><a href=" // deprecated" title="{$tlink9}">{$tlink9}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link10}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link10}" title="{$tlink10}">{$tlink10}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link11}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link11}" title="{$tlink11}">{$tlink11}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link12}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link12}" title="{$tlink12}">{$tlink12}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link13}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link14}" title="{$tlink13}">{$tlink13}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link14}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link14}" title="{$tlink14}">{$tlink14}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link15}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link15}" title="{$tlink15}">{$tlink15}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link16}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link16}" title="{$tlink16}">{$tlink16}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link17}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link17}" title="{$tlink17}">{$tlink17}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link18}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link18}" title="{$tlink18}">{$tlink18}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link19}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link19}" title="{$tlink19}">{$tlink19}</a></td>
...
<tr>
<td class="coll-1 name"><a href="{$link20}" class="icon"><i class="flaticon-apps"></i></a><a href="{$link20}" title="{$tlink20}">{$tlink20}</a></td>
