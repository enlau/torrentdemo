...
$tpl->template_dir	= $_SERVER['DOCUMENT_ROOT'] . '/applications';
$tpl->compile_dir	= $_SERVER['DOCUMENT_ROOT'] . '/applications/templates_c';   


//Your website title
$defaulttitle = 'Software Applications';
...
// Your keyword file, the name of torrents you want to create pages and torrents for.
$keyword_file = $_SERVER['DOCUMENT_ROOT'] . '/applications/data/titles.txt';
...
// your torrent rss feed url for applications
$rss_url = 'https://thepiratebay.party/rss/new/301'; 
$torrentlocation = $_SERVER['DOCUMENT_ROOT'] . '/applications/torrents'; 
$torrentl = $_SERVER['DOCUMENT_ROOT'] . '/applications/torrents';


//avatar image location
$authorImageLocation = $_SERVER['DOCUMENT_ROOT'] . '/applications/product';
$lastpic = 170;
$picsperpage = 7;
$maxpic = 170;
