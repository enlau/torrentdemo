<?php
/* Smarty version 4.3.2, created on 2026-06-23 11:59:47
  from '/home/rbgvtenu/torrentdemo.enlau.dev/applications/newresult.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_6a3a75334b5028_00901673',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '538593cfe48a030799eb426c848f9f31e65c869b' => 
    array (
      0 => '/home/rbgvtenu/torrentdemo.enlau.dev/applications/newresult.tpl',
      1 => 1780921471,
      2 => 'file',
    ),
  ),
...
function content_6a3a75334b5028_00901673 (Smarty_Internal_Template $_smarty_tpl) {
...
<title>Search Results For <?php echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['newentry']->value,'%20',' '),'#','.'),'/','.'),'\\','.'),'%','.'),'[','.'),']','.');?>
</title>
<meta name="description" content="Search Results For <?php echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['newentry']->value,'%20',' '),'#','.'),'/','.'),'\\','.'),'%','.'),'[','.'),']','.');?>
">
<meta name="keywords" content="<?php echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['newentry']->value,'%20',' '),'#','.'),'/','.'),'\\','.'),'%','.'),'[','.'),']','.');?>
">
...
<h1><span class="featured-icon"><i class="flaticon-apps"></i></span> Top 4 Search Results For:  <?php echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['newentry']->value,'%20',' '),'#','.'),'/','.'),'\\','.'),'%','.'),'[','.'),']','.');?>
 </h1>
...
<tbody>
<tr>
<td class="coll-1 name"><a href="<?php echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['newentry']->value,'/','-'),' ','-'),'%7B','-'),'%7D','-'),'#','.'),'\/','-'),'\\','-'),'%','.'),'[','.'),']','.');?>
...
.html" class="icon"><i class="flaticon-apps"></i></a><a href="<?php echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['newentry']->value,'/','-'),' ','-'),'%7B','-'),'%7D','-'),'#','.'),'\/','-'),'\\','-'),'%','.'),'[','.'),']','.');?>
-<?php echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['appgroup1']->value,'/','-'),' ','-'),'%7B','-'),'%7D','-'),'#','.'),'\/','-'),'\\','-'),'%','.'),'[','.'),']','.');?>
.html"><?php echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['newentry']->value,'/','-'),'%7B','-'),'%7D','-'),'#','.'),'\/','-'),'\\','-'),'%','.'),'[','.'),']','.');?>
